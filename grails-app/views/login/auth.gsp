...
<div id="loginPanel" class="mooSlide">
    ...
    <div class="login s2ui_center ui-corner-all" style='text-align:center;'>
        <div class="login-inner">
            <form class="left" action='${postUrl}' method='POST' id="loginForm" name="loginForm" autocomplete='off'>
                <div class="sign-in">
...
<div id="container">
    <div id="content">
        ...
        <center>
            <div>
                <img style="margin-left:20px; margin-top: 350px" src="../images/stethescope.png" alt="" />
